 ...
 */
public class CrecerFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public CrecerFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_crecer, container, false);
        Toast.makeText(getContext(), getString(R.string.title_crecer), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_crecer, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewCrecer);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.402983, -66.038842)).title("AGENCIA SACABA").snippet("");
