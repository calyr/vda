 ...
 */
public class BancoprodemFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public BancoprodemFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bancoprodem, container, false);
        Toast.makeText(getContext(),getString(R.string.title_prodem), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_bancoprodem, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewProdem);
        ...
        MarkerOptions markerend2 = new MarkerOptions().position(
                new LatLng(-17.403630, -66.039983)).title("AGENCIA SACABA").snippet("Plaza 6 de Agosto Nº  11, acera Norte.");
