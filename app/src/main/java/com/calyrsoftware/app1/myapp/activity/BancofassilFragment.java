 ...
 */
public class BancofassilFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public BancofassilFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bancofassil, container, false);
        Toast.makeText(getContext(), getString(R.string.title_fassil), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_bancofassil, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewFassil);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.375404,-66.129242)).title("AGENCIA PACATA").snippet("Av. Elidoro Villazón N° 2208 Km 1, carretera a Sacaba, frente a la Rotonda del Servicio Nacional de Caminos");
        ...
        MarkerOptions markerend2 = new MarkerOptions().position(
                new LatLng(-17.404126, -66.040739)).title("AGENCIA SACABA").snippet("Calle Monseñor Roberto Nicoli esquina Calle La Tapia ");
