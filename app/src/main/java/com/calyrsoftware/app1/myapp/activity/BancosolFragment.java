...
/**
 * Created by calyr on 11/5/15.
 */
public class BancosolFragment  extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public BancosolFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bancosol, container, false);
        Toast.makeText(getContext(), getString(R.string.title_sol), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_bancosol, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewSol);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.403551, -66.040423)).title("AGENCIA SACABA").snippet("Calle Junin entre Benemeritos de la Patria y Aroma."
        );
