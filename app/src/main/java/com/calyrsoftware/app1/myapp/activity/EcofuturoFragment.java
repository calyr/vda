 ...
 */
public class EcofuturoFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public EcofuturoFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_ecofuturo, container, false);
        Toast.makeText(getContext(), getString(R.string.title_ecofuturo), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_ecofuturo, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewEcofuturo);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.40446965010315,-66.03943741269177)).title("SACABA").snippet("Calle Sucre s/n entre Bolívar y Cnl. Sánchez");
