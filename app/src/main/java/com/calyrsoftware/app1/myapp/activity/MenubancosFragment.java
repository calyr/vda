...
import com.calyrsoftware.app1.myapp.adapter.MenubancosAdapter;
import com.calyrsoftware.app1.myapp.adapter.MenuprincipalAdapter;
import com.calyrsoftware.app1.myapp.model.Menubancos;
...
public class MenubancosFragment extends Fragment {
    ...
    private void initDataset() {
        ...
        mDataset.add( new Menubancos(R.drawable.losandes));

        mDataset.add( new Menubancos(R.drawable.fortaleza));
        mDataset.add( new Menubancos(R.drawable.bancosol));
        mDataset.add(new Menubancos(R.drawable.ecofuturo));
        mDataset.add( new Menubancos(R.drawable.prodem));
        mDataset.add( new Menubancos(R.drawable.fassil));

        mDataset.add( new Menubancos(R.drawable.quillacollo));

        mDataset.add( new Menubancos(R.drawable.crecer));

        mDataset.add(new Menubancos(R.drawable.piox));


        mDataset.add( new Menubancos(R.drawable.cacef));


        mDataset.add( new Menubancos(R.drawable.emprender));


        mDataset.add( new Menubancos(R.drawable.fubode));
