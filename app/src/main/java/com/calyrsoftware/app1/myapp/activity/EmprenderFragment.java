 ...
 */
public class EmprenderFragment  extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public EmprenderFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_emprender, container, false);
        Toast.makeText(getContext(),getString(R.string.title_emprender), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_emprender, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewEmprender);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.403121, -66.038905)).title("AGENCIA SACABA").snippet("Av Ayacucho esq. c. Melgarejo, entre Av. Monseñor Alcocer y c. Bolivar.");
