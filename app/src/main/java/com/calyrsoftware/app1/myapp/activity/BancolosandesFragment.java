 ...
 */
public class BancolosandesFragment  extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public BancolosandesFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_losandes, container, false);
        Toast.makeText(getContext(),getString(R.string.title_losandes), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_losandes, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewLosandes);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.404675, -66.040807)).title("AGENCIA SACABA").snippet("Plaza 6 de Agosto (acera  norte)");
