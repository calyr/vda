 ...
 */
public class BancoeconomicoFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public BancoeconomicoFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bancoeconomico, container, false);
        Toast.makeText(getContext(), getString(R.string.title_economico), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_bancoeconomico, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewEconomico);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.4043889,-66.0406917)).title("Agencia Sacaba").snippet("Calle Tapia # 427, a media cuadra Plaza Principal.");
