 ...
 */
public class FubodeFragment  extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public FubodeFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fubode, container, false);
        Toast.makeText(getContext(),getString(R.string.title_fubode), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_fubode, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewFubode);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.404108, -66.038651)).title("SACABA").snippet("Calle Bolívar Esq. Calle Colón s/n.");
