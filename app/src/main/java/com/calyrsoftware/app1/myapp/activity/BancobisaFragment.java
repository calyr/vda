 ...
 */
public class BancobisaFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public BancobisaFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bancobisa, container, false);
        Toast.makeText(getContext(), getString(R.string.title_bisa), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_bancobisa, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewBancobisa);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.402380, -66.038542)).title("AGENCIA SACABA").snippet("Calle Colombia s/n entre Calles Monseñor Alcocer y Bolívar(SACABA)");
