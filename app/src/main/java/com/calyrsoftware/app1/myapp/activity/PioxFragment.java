 ...
 */
public class PioxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_piox, container, false);
        Toast.makeText(getContext(), getString(R.string.title_piox), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_piox, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewPiox);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.403283, -66.040760)).title("SACABA").snippet("Calle Junin N.155 a media cuadra de la plaza");
