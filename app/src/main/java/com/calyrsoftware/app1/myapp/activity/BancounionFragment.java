 ...
 */
public class BancounionFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public BancounionFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_bancounion, container, false);
        Toast.makeText(getContext(),getString(R.string.title_union), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_bancounion, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewUnion);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.405437, -66.038005)).title("AGENCIA SACABA").snippet("Calle Sucre E-200 esquina Independencia diagonal mercado central de Sacaba / Centro / "
        );
        ...
        /*MarkerOptions markerend2 = new MarkerOptions().position(
                new LatLng(-17.400563, -66.038230)).title("AGENCIA 2 SACABA").snippet("Av. Monseñor Alcocer esq. Avenida  Barrientos (Carretera a SCZ)");
