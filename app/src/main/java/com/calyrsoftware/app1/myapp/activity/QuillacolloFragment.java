 ...
 */
public class QuillacolloFragment extends Fragment {

    MapView mMapView;
    private GoogleMap googleMap; // Might be null if Google Play services APK is not available.
    public QuillacolloFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_quillacollo, container, false);
        Toast.makeText(getContext(), getString(R.string.title_quillacollo), Toast.LENGTH_SHORT).show();
        //setUpMapIfNeeded(rootView);
        // inflat and return the layout
        View v = inflater.inflate(R.layout.fragment_quillacollo, container,
                false);
        mMapView = (MapView) v.findViewById(R.id.mapViewQuillacollo);
        ...
        MarkerOptions markerend = new MarkerOptions().position(
                new LatLng(-17.403862, -66.037558)).title("AGENCIA SACABA").snippet("Calle Independencia E-0201 Esq. Ayacucho");
